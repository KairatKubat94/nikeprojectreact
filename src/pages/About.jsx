    ...
    <div className={styles.about}>
      ...
      <div className={styles.container}>
        <section className={styles.section}>
          ...
          <p>
            STRIDE родился из убеждения, что высокая производительность и минимальный дизайн 
            идеально дополняют друг друга. В 2020 году наша команда профессиональных дизайнеров 
            и спортсменов объединилась, чтобы создать спортивную одежду и обувь нового поколения.
          </p>
          <p>
